...
The dashboard provides a clear, single-page view of key churn metrics and allows users to explore insights through filters and drill-through analysis.
...
| Churned Customers | Customers who have left |
| Churn Rate (%) | Percentage of churned customers |
| Average Monthly Charges | Average billing amount |
...
This project demonstrates how business intelligence tools can be used to uncover churn patterns and support proactive customer retention strategies. The dashboard serves as a practical decision-support system for stakeholders.
